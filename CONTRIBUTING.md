# Contributing to biz.dfch.AsdSte100Rules

Thank you for your interest in contributing to **biz.dfch.AsdSte100Rules**!  
...
- **Bug reports**: Open an issue in the GitHub issue tracker:
  - URL: `https://github.com/dfch/biz.dfch.AsdSte100Rules/issues`
  - Include:
    - Steps to reproduce
    - Expected behavior
    - Actual behavior
...
```bash
git clone https://github.com/dfch/biz.dfch.AsdSte100Rules.git
cd biz.dfch.AsdSte100Rules
